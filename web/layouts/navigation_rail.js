...
class NavigationRail {
    ...
    static HeightLayoutNavigationRailItem = 3.5;  // 3.5rem = 56px
    ...
    setUpNavRailDrawer() {
        ...
        // Verification
        if(this.navigationRailDrawer === undefined || this.navigationRailDrawer === null) {
            return;
        }
        ...
        for(let i = 0; i < this.navigationRailItemsDropdown.length; i++) {
            ...
            if(dropdownContainer === null || dropdownContainer === undefined || !dropdownContainer.classList.contains(Layout.ClassNameLayoutNavigationRailDrawerContainerDropdown)) {
                continue;
            }
