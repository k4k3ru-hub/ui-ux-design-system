...
export class HtmlComponentVitePlugin {
  ...
  private configure(
    ...
    this.componentsDirectory = resolve(
      config.root,
      this.options.componentsDirectory ?? "components",
    );
  ...
  private configureServer(
    ...
    if (this.componentsDirectory === "") {
      throw new Error(
        "HTML component plugin has not been configured",
      );
    }
...
export function htmlComponentPlugin(
  options: HtmlComponentPluginOptions = {},
): Plugin {
